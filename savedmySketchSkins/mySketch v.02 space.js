...
const CONFIG = {
  ...
  BLOCK_SIZE: 32,                  // Size of each block in pixels (try: 20-100)
  ...
  TEXT_SIZE_RATIO: 0.4,              // Text size as ratio of block size (try: 0.2-0.4)
  FOOTER_TEXT_SIZE: 14,              // Fixed text size in pixels (try: 10-20)
  FOOTER_MARGIN_X: 150,               // Horizontal margin from edge in pixels (try: 10-50)
  FOOTER_MARGIN_Y: 135,               // Vertical margin from bottom in pixels (try: 10-50)
  ...
  SHAPE_LAYERS: 2,                   // Number of layers per shape pattern (try: 2-6)
  ...
  FORCE_PALETTE_INDEX: 36,            // Force specific palette (0-17, only if USE_RANDOM_PALETTE is false)
...
function drawFooterText() {
  ...
  text("pirouette v.02 space", xRight, yPos);
}
